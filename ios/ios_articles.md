...
- [Stanford iOS Course](https://podcasts.apple.com/us/podcast/developing-ios-11-apps-with-swift/id1315130780?mt=2)
...
- [AvAudioPlayer](http://blog.mallow-tech.com/2016/01/avaudioplayer-how-to-work-it/)

## Combine
- [Combine101](https://github.com/learncombine/Combine101)

## Dependency Management
- [Carthage](https://www.raywenderlich.com/416-carthage-tutorial-getting-started)
- [Adding a Framework](https://www.raywenderlich.com/5109-creating-a-framework-for-ios)
- [Creating a Pod](https://guides.cocoapods.org/making/making-a-cocoapod.html)
- [SwiftPM](https://medium.com/better-programming/add-swift-package-dependency-to-an-ios-project-with-xcode-11-remote-local-public-private-3a7577fac6b2)

## Moya
- [Providers](https://github.com/Moya/Moya/blob/master/docs/Providers.md#advanced-usage)
- [Get Response Header](https://stackoverflow.com/questions/43752351/get-response-header-with-moya)
- [Interceptors](https://stackoverflow.com/questions/40116000/how-can-i-set-timeout-for-requests-using-moya-pod)
- [Rx + Codable](https://apiumhub.com/tech-blog-barcelona/data-layer-with-moyarx-and-codable/)
- [Scaling Moya](https://sunshinejr.com/2018/04/11/scaling-moya-in-production/)

## Maps
- [Google Maps](https://www.raywenderlich.com/197-google-maps-ios-sdk-tutorial-getting-started)
...
- [RxNetWorking](https://github.com/JunDang/RxNetWorking)

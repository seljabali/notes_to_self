...
- [Tech Books](http://www.nomachetejuggling.com/2014/02/05/top-10-career-changing-programming-books/)

- [Books](https://www.hanselman.com/blog/CategoryView.aspx?category=Source+Code)
...
- [Math](http://tutorial.math.lamar.edu)

- [Linear Algebra](http://www.math.odu.edu/~bogacki/cgi-bin/lat.cgi)
...
- [Philosophy](http://www.openculture.com/philosophy_free_courses)

- [Aristotle](http://leostrausscenter.uchicago.edu/course/aristotle-ethics)

- [R Exercises](http://www.r-exercises.com/start-here-to-learn-r/)

- [R tutorials](http://www.walware.de/goto/statet)

- [Ruby](http://ruby-doc.org)

- [LaTex](https://projects.eclipse.org/projects/science.texlipse)

- [FlapJax](http://www.flapjax-lang.org/tutorial/)

- [Lua](http://luaeclipse.luaforge.net/manual.html#installation)

- [SVN](http://www.linuxfromscratch.org/blfs/edguide/chapter03.html#ch03-introduction)

- [SVN Books](http://svnbook.red-bean.com/en/1.2/svn.tour.other.html#svn.tour.other.import)

- [Super Memo](https://www.supermemo.com/en): Never Forget a thing!
...
- [Open Source Computer Vision Library](https://opencv.org/about.html)

- [Free BSD](http://www.freebsdsoftware.org)

- [Game Crafters](http://gamescrafters.berkeley.edu)

- [Scratch](https://scratch.mit.edu/)

- [CS Illustrated](http://csillustrated.berkeley.edu)
